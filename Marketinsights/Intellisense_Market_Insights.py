...
# query = "urls that contain publicly accessible quantitative information of latest market insights of healthcare, banking, finance and technology sector with performance indicators and global economy overview"
query = """Trending market information that give publicly accessible quantitative information and
        statistical graphs, charts on latest market insights of healthcare, banking, finance and technology sector 
        with performance indicators and global economy overview, international trade that can be useful for market 
...
def get_market_insights():
    ...
    print("AI Response is : ", actual_content)
